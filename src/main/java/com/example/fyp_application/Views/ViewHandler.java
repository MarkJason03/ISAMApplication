...
public class ViewHandler {
    ...
    public static final String CLIENT_DASHBOARD_VIEW = "/FXML/ClientView/ModifiedDashboard.fxml";
    public static final String CLIENT_SIDEBAR_MENU = "/FXML/ClientView/ClientSideBar.fxml";
